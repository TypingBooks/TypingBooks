...
(function (a, b) {
    ...
    function r(a, c) {
        ...
        return (g && !e ? c.contains(k) : c === k && 'BODY' !== k.nodeName) && (r = l(r, c)),
        r
    }
    function s(a) {
    ...
    function L(a, b) {
        return K(a).removeEventListener('resize', b.updateBound),
    ...
    function Q(a, b, c, e) {
        c.updateBound = e,
        K(a).addEventListener('resize', c.updateBound, {
            passive: !0
        });
        var f = d(a);
        return P(f, 'scroll', c.updateBound, c.scrollParents),
        c.scrollElement = f,
        c.eventsEnabled = !0,
        c
    }
    ...
    W = function () {
        for (var a = ['Edge', 'Trident', 'Firefox'], b = 0; b < a.length; b += 1)
            if (S && 0 <= navigator.userAgent.indexOf(a[b]))
                return 1;
        return 0
    }
    (),
