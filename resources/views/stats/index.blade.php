 ...
 <div class="jumbotron jumbotron-fluid mb-3">
  <div class="container">
    ...
    <p class="lead">{{__('all_stats.stats_for_the_user')}} <a href="{{ $user->getStatsAddress() }}">{{ $user->name }}</a> </p>
  </div>
</div>
 ...
 <div class="card mb-3">
	<div class="card-header">{{__('all_stats.last_100_tests')}}</div>
	<div class="card-body">
 ...
 <div class="card mb-3">
	...
	<div class="card-body">
		...
		<a class="btn btn-sm btn-primary" href="{{ url('/stats/' . $user->id . '/books') }}">{{__('all_stats.all_books_for_user')}}</a>
 ...
 <div class="card mb-3">
	<div class="card-header">{{__('all_stats.last_language')}}: {{ __('languages.' . $language->abbreviation) }}</div>
	<div class="card-body">
		...
		<div class="row">
		<div class="col-sm-12" align="right">
		<a class="btn btn-sm btn-primary" href="{{ url('/stats/' . $user->id . '/languages') }}">{{__('all_stats.all_languages_for_user')}}</a>
