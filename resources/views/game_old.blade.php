					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item">
								<a href="{{ url('/') }}">@lang('crumb.language') {{ __('languages.' . \App\Language::find($data->native_language)->abbreviation) }}</a>
							</li>
							<li class="breadcrumb-item">
			...
			>
				<div class="col-sm-6 mb-3 d-flex">
					<div class="card w-100 ">
						<h5 class="card-header">@lang('game.grammar_explanation')</h5>
						<div class="card-body " align="center">
						<p class="card-text text-break">
								<span id="grammarText">{{ $data->grammar[0] }}</span>
								</p>
						</div>
					</div>
				</div>
